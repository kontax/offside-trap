...
""" 
Dict to outline whether the dynamic entry's d_un property is a pointer or value. If it is a pointer, then any shifting
of sections/segments needs to also be shifted by that amount.
See: https://docs.oracle.com/cd/E23824_01/html/819-0690/chapter6-42444.html
"""
DYNAMIC_TAG_UNION = {
    DynamicTag.DT_NULL: "Ignored",
    DynamicTag.DT_NEEDED: "d_val",
    DynamicTag.DT_PLTRELSZ: "d_val",
    DynamicTag.DT_PLTGOT: "d_ptr",
    DynamicTag.DT_HASH: "d_ptr",
    DynamicTag.DT_STRTAB: "d_ptr",
    DynamicTag.DT_SYMTAB: "d_ptr",
    DynamicTag.DT_RELA: "d_ptr",
    DynamicTag.DT_RELASZ: "d_val",
    DynamicTag.DT_RELAENT: "d_val",
    DynamicTag.DT_STRSZ: "d_val",
    DynamicTag.DT_SYMENT: "d_val",
    DynamicTag.DT_INIT: "d_ptr",
    DynamicTag.DT_FINI: "d_ptr",
    DynamicTag.DT_SONAME: "d_val",
    DynamicTag.DT_RPATH: "d_val",
    DynamicTag.DT_SYMBOLIC: "Ignored",
    DynamicTag.DT_REL: "d_ptr",
    DynamicTag.DT_RELSZ: "d_val",
    DynamicTag.DT_RELENT: "d_val",
    DynamicTag.DT_PLTREL: "d_val",
    DynamicTag.DT_DEBUG: "d_ptr",
    DynamicTag.DT_TEXTREL: "Ignored",
    DynamicTag.DT_JMPREL: "d_ptr",
    DynamicTag.DT_BIND_NOW: "Ignored",
    DynamicTag.DT_INIT_ARRAY: "d_ptr",
    DynamicTag.DT_FINI_ARRAY: "d_ptr",
    DynamicTag.DT_INIT_ARRAYSZ: "d_val",
    DynamicTag.DT_FINI_ARRAYSZ: "d_val",
    DynamicTag.DT_RUNPATH: "d_val",
    DynamicTag.DT_FLAGS: "d_val",
    DynamicTag.DT_ENCODING: "Unspecified",
    DynamicTag.DT_PREINIT_ARRAY: "d_ptr",
    DynamicTag.DT_PREINIT_ARRAYSZ: "d_val",
    DynamicTag.DT_SYMTAB_SHNDX: "Unspecified",
    DynamicTag.DT_LOOS: "Unspecified",
    DynamicTag.DT_HIOS: "Unspecified",
    DynamicTag.DT_VALRNGLO: "Unspecified",
    DynamicTag.DT_CHECKSUM: "d_val",
    DynamicTag.DT_PLTPADSZ: "d_val",
    DynamicTag.DT_MOVEENT: "d_val",
    DynamicTag.DT_MOVESZ: "d_val",
    DynamicTag.DT_POSFLAG_1: "d_val",
    DynamicTag.DT_SYMINSZ: "d_val",
    DynamicTag.DT_SYMINENT: "d_val",
    DynamicTag.DT_VALRNGHI: "Unspecified",
    DynamicTag.DT_ADDRRNGLO: "Unspecified",
    DynamicTag.DT_CONFIG: "d_ptr",
    DynamicTag.DT_DEPAUDIT: "d_ptr",
    DynamicTag.DT_AUDIT: "d_ptr",
    DynamicTag.DT_PLTPAD: "d_ptr",
    DynamicTag.DT_MOVETAB: "d_ptr",
    DynamicTag.DT_SYMINFO: "d_ptr",
    DynamicTag.DT_ADDRRNGHI: "Unspecified",
    DynamicTag.DT_RELACOUNT: "d_val",
    DynamicTag.DT_RELCOUNT: "d_val",
    DynamicTag.DT_FLAGS_1: "d_val",
    DynamicTag.DT_VERDEF: "d_ptr",
    DynamicTag.DT_VERDEFNUM: "d_val",
    DynamicTag.DT_VERNEED: "d_ptr",
    DynamicTag.DT_VERNEEDNUM: "d_val",
    DynamicTag.DT_LOPROC: "Unspecified",
    DynamicTag.DT_AUXILIARY: "d_val",
    DynamicTag.DT_USED: "d_val",
    DynamicTag.DT_FILTER: "d_val",
    DynamicTag.DT_HIPROC: "Unspecified",
    DynamicTag.DT_FEATURE: "Unknown",
    DynamicTag.DT_GNU_CONFLICT: "d_ptr",
    DynamicTag.DT_GNU_CONFLICTSZ: "d_val",
    DynamicTag.DT_GNU_HASH: "d_ptr",
    DynamicTag.DT_GNU_LIBLIST: "d_ptr",
    DynamicTag.DT_GNU_LIBLISTSZ: "d_val",
    DynamicTag.DT_GNU_PRELINKED: "d_val",
    DynamicTag.DT_TLSDESC_GOT: "Unknown",
    DynamicTag.DT_TLSDESC_PLT: "Unknown",
    DynamicTag.DT_VERSYM: "d_ptr",
    DynamicTag.OLD_DT_HIOS: "Unknown",
    DynamicTag.OLD_DT_LOOS: "Unknown",
}
